...
def procuraCaminho(mapa, lin, col):
    ...
    if(not(mapa[lin - 1][col] == 'T' or mapa[lin][col + 1] == 'T' or mapa[lin + 1][col] == 'T' or mapa[lin][col - 1] == 'T')) and procuraCaminho(mapa, lin - 1, col):
        return True

    elif (not(mapa[lin - 1][col] == 'T' or mapa[lin][col + 1] == 'T' or mapa[lin + 1][col] == 'T' or mapa[lin][col - 1] == 'T')) and procuraCaminho(mapa, lin, col + 1):  # direita
        return True

    elif (not(mapa[lin - 1][col] == 'T' or mapa[lin][col + 1] == 'T' or mapa[lin + 1][col] == 'T' or mapa[lin][col - 1] == 'T')) and procuraCaminho(mapa, lin + 1, col):  # baixo
        return True

    elif (not(mapa[lin - 1][col] == 'T' or mapa[lin][col + 1] == 'T' or mapa[lin + 1][col] == 'T' or mapa[lin][col - 1] == 'T')) and procuraCaminho(mapa, lin, col - 1):  # esquerda
        return True
